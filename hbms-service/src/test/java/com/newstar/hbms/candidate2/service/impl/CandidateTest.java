...
//  }
  ...
  public void testInsertResume() throws IOException {
    ...
    candidate.setEducation("大专");
    candidate.setWorkYears("3年");
    candidate.setMarital("已婚");
    candidate.setLocation("居住地");
    candidate.setIndustry("行业");
    candidate.setCompany("公司");
    candidate.setPosition("职位");
    candidate.setSalary("薪资");
    candidate.setSelfEvaluation("个人评价");
